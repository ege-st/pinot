...
import org.apache.pinot.segment.local.realtime.impl.forward.FixedByteSparseDocMajorMapMutableForwardIndex;
...
public class BenchmarkFixedByteDocMajorFwdIndex {
  private static final int NROWS = 1000;
  private static final int MAX_N_VALUES = 1000;
  private PinotDataBufferMemoryManager _memoryManager;
  private FixedByteSparseDocMajorMapMutableForwardIndex _index;
  ...
  public static void main(String[] args)
      throws Exception {
    new Runner(new OptionsBuilder().include(BenchmarkFixedByteDocMajorFwdIndex.class.getSimpleName()).build()).run();
  }
}
