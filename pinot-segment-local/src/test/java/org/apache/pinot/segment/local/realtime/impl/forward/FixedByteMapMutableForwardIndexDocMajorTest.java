...
public class FixedByteMapMutableForwardIndexDocMajorTest {
  ...
  @BeforeClass
  public void setup() {
    _memoryManager = new DirectMemoryManager(FixedByteMapMutableForwardIndexDocMajorTest.class.getName());
  }
